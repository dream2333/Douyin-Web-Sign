...
window['localStorage']['removeItem'] = function () { return null }

navigator = {}
navigator.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36 Edg/118.0.2088.61'
...
var query = "https://www.douyin.com/aweme/v1/web/aweme/post/?device_platform=webapp&aid=6383&channel=channel_pc_web&sec_user_id=MS4wLjABAAAANwHuHpgAgTOCEkKQuL3bs-z3JZ2JVKwzyFyoGoh2TfQJWFREy3pYCjLrDeD2ErGR&max_cursor=1690945565000&locate_item_id=7291899908880108811&locate_query=false&show_live_replay_strategy=1&need_time_list=0&time_list_query=0&whale_cut_token=&cut_version=1&count=18&publish_video_strategy_type=2&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1440&screen_height=900&browser_language=zh-CN&browser_platform=Win32&browser_name=Edge&browser_version=118.0.2088.61&browser_online=true&engine_name=Blink&engine_version=118.0.0.0&os_name=Windows&os_version=10&cpu_core_num=16&device_memory=8&platform=PC&downlink=10&effective_type=4g&round_trip_time=50&webid=7294559525708252723&msToken="
var start = new Date().getTime()
for (var i = 0; i < 1000; i++) {
  var xb = window.xb_sign(query, null)
}
